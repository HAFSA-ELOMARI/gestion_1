...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"select * from tblstudents where emailAddress ='$emailAddress'");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,otherName,emailAddress,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$otherName','$emailAddress','12345','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$otherName', emailAddress='$emailAddress',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
