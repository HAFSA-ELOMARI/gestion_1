      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tableau de Bord du etudient (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>)</h1>
            <ol class="breadcrumb">
          ...
          <div class="row mb-3">
          <!-- Carte Nouveaux Étudiants -->
          <?php 
$query1=mysqli_query($conn,"SELECT * FROM `tblclassteacher` ORDER BY `tblclassteacher`.`lastName` ");                       
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">profisseur</div>
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $classTeacher;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Sections de Classe</div>
