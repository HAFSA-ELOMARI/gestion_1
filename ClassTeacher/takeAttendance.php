...
//session and Term
        ...
        if($count == 0){ //if Record does not exsit, insert the new record
          ...
          while ($ros = $qus->fetch_assoc())
          {
              ...
              value('$ros[emailAddress]','$_SESSION[classId]','$_SESSION[classArmId]','$sessionTermId','0','$dateTaken')");
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><input name='check[]' type='checkbox' value=".$rows['emailAddress']." class='form-control'></td>
                              </tr>";
                              echo "<input name='admissionNo[]' value=".$rows['emailAddress']." type='hidden' class='form-control'>";
                          }
                      }
                      else
                      {
