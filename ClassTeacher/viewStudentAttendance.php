                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="emailAddress" class="form-control mb-3">';
                          echo'<option value="">--Select Student--</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['emailAddress'].'" >'.$rows['firstName'].' '.$rows['lastName'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        tblstudents.firstName,tblstudents.lastName,tblstudents.otherName,tblstudents.emailAddress
                        FROM tblattendance
                        INNER JOIN tblclass ON tblclass.Id = tblattendance.classId
                        INNER JOIN tblclassarms ON tblclassarms.Id = tblattendance.classArmId
                        INNER JOIN tblsessionterm ON tblsessionterm.Id = tblattendance.sessionTermId
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.emailAddress = tblattendance.admissionNo
                        where tblattendance.admissionNo = '$emailAddress' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.emailAddress = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.admissionNo = '$emailAddress' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.emailAddress = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.admissionNo = '$emailAddress' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
